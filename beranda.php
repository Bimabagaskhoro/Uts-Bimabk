		...
		<div class='content-wrapper' style='background-image: url(backgroun.jpg);background-size: cover;'>
			<section class='content-header' style="height:102px;z-index:0;background:#00a896">
				...
				<div style='float:right; margin-top:-37px'>
					...
					<button class='btn  btn-flat  bg-maroon'><span id='waktu'>18:03:37</span></button>
				</div>
			...
			<section class='content' style="margin-top:-65px">
										...
										<div class='box box-solid direct-chat direct-chat-warning'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													...
													<a href='?pg=&ac=clearpengumuman' class='btn btn-default' title='Bersihkan Pengumuman'><i class='fa fa-trash'></i></a>
												</div>
											</div>
											<div class='box-body'>
												<div id='pengumuman'>
													<p class='text-center'>
														<br /><i class='fa fa-spin fa-circle-o-notch'></i>buatlah project ujian online 
														Buatlah UI(user Interfrace)
														untuk menu data master silahkan di clik.... .buatlah 3 menu saja tinggal pilih. minimal 10 data yang tampil, tidak perlu link ke database
													</p>
													<p> Untuk Nomor Induk Mahasiswa yang ganjil</p>
													<ul>
													<li> Data Mata Kuliah (perbaiki sesuai dengan mata kuliah di kampus anda data bebas).dengan  nama file data_mata_kuliah.php</li>
													<li> Data Jenis Ujian (Kode jenis ujian, nama jenis ujian ,data bebas contoh TG2,tugas1,TG2,tugas2,uts, uas dll. dengan  nama file Data_Jenis_Ujian.php</li>
													<li> Data Prodi (kode prodi, nama prodi data bebas contoh teknik informatika,teknik industri dll).nama file Data_Prodi.php </li>
												   </ul>
														<br>
														<p> Untuk Nomor Induk Mahasiswa yang genap</p>
													<ul>	
													<li> Data Mata Kuliah (perbaiki sesuai dengan mata kuliah di kampus anda data bebas).dengan  nama file data_mata_kuliah.php</li>
													<li> Data Kelas  (Kode kelas, nama kelas ,data bebas contoh FTI4B001,FTI semester 4 kelas B  dll. dengan  nama file data_kelas.php</li>
													<li> Data Sesi (kode sesi, nama sesi data bebas contoh PG1,pagi jam 8.00 sd 9.00 wib dll). dengan  nama file data_sesi.php</li>
													</ul>
													
														<p> Untuk tugas yang sama</p>
													<ul>	
													<li> ganti logo dikiriatas  menjadi logo ubharajaya.</li>
													<li> APLIKASI UJIAN BERBASIS KOMPUTER  gati menjadi Apliaksi Ujian Online</li>
													<li> gambar di form login gati bebas</li>
													</ul>
												</div>
											</div>
										</div>
							...
							<div class='animated flipInX col-md-4'>
								<div class='box box-solid direct-chat direct-chat-warning'>
									<div class='box-header with-border'>
										<h3 class='box-title'><i class='fa fa-history'></i> cara penggunaan</h3>
										<div class='box-tools pull-right'>
											<a href='?pg=&ac=clearlog' class='btn btn-default' title='Bersihkan Log'><i class='fa fa-trash'></i></a>
										</div>
									</div>
									<div class='box-body'>
										<div id='log-list'>
											<p class='text-center'>
												<br /><i class='fa fa-spin fa-circle-o-notch'></i> 
												<ul>
												<li>
												 copy file soal_uts_namakamu.zip ke folder xampp/htdocs, lakukan extrax ,akan terbentuk folder soal_uts_namakamu, kemudian ganti foldernya dengan 
												 soal_uts_namakamu dengan nama kamu contoh udin menjadi soal_uts_udin(nama folder).						
												</li>
												<li>Jalankan aplikasi berbasi web dengan php dengan url:: <b><i>localhost/soal_uts_udin </i></b>kemudian enter
												</li>
												<li>setelah melakukan enter akan muncul form login user: admin dan password: admin,lakukan clik pada tombol login masuk, jika berhasil akan
												masuk kedalam halaman  admin sebagai back end.
												</li>
												<li>untuk membuat file yang lain silahkan copy file data_mata_kuliah.php menjadi misal data_prodi.php
												kemudian lakukan modifikasi sesuai dengan keinginan.
												</li>
												<li>untuk link menu contoh untuk bisa dilakukan click dari menu data mata kuliah buka file beranda.php lihat baris ke.139, lihat
												perintah href='data_mata_kuliah.php'.
												</li>
