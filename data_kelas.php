							...
							<div class='box box-solid'>
								<div class='box-header with-border'>
									...
									<div class='box-tools pull-right '>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#tambahmapel'><i class='fa fa-check'></i> Tambah Kelas</button>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#importmapel'><i class='fa fa-upload'></i> Import Kelas</button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
									<div class='table-responsive'>
										...
										<thead>
											...
											<tbody>
												...
												<tr>
													<td><?php echo $no; ?></td>
         											<td><?php echo $row['mataKuliah_kls']; ?></td>
							...
							<div class='modal-dialog'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<form action='tambah_dataKelas.php' method='post'>
											<div class='form-group'>
												<label>Mata Kuliah</label>
												<input type='text' name='mataKuliah_kls' class='form-control' required='true' />
											</div>
											<div class='form-group'>
												<label>Nama Mata Kuliah</label>
												<input type='text' name='kode_kelas' class='form-control' required='true' />
											</div>
