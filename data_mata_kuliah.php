							...
							<div class='box box-solid'>
								<div class='box-header with-border'>
									...
									<div class='box-tools pull-right '>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#tambahmapel'><i class='fa fa-check'></i> Tambah Matkul</button>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#importmapel'><i class='fa fa-upload'></i> Import Matkul</button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
									<div class='table-responsive'>
										<table id='tablemapel' class='table table-bordered table-striped'>
											...
											<tbody>
												<?php
												 $query = "SELECT * FROM data_matkul ORDER BY id ASC";
							...
							<div class='modal-dialog'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<form action='tambah_dataMatkul.php' method='post'>
											<div class='form-group'>
												<label>Kode Matkul</label>
												<input type='text' name='kodematkul' class='form-control' required='true' />
											</div>
											<div class='form-group'>
