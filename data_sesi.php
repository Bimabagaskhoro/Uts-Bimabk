							...
							<div class='box box-solid'>
								<div class='box-header with-border'>
									...
									<div class='box-tools pull-right '>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#tambahmapel'><i class='fa fa-check'></i> Tambah Sesi</button>
										<button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#importmapel'><i class='fa fa-upload'></i> Import Sesi</button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
									<div class='table-responsive'>
										...
										<thead>
											...
											<tbody>
												<?php
												 $query = "SELECT * FROM data_sesi ORDER BY id_sesi ASC";
												...
												<tr>
													<td><?php echo $no; ?></td>
         											<td><?php echo $row['matkul_sesi']; ?></td>
         											<td><?php echo $row['kode_sesi']; ?></td>	
												</tr>
							...
							<div class='modal-dialog'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										<form action='tambah_dataSesi.php' method='post'>
											<div class='form-group'>
												<label>Mata Kuliah</label>
												<input type='text' name='matkul_sesi' class='form-control' required='true' />
											</div>
											<div class='form-group'>
												<label>Kode Sesi</label>
												<input type='text' name='kode_sesi' class='form-control' required='true' />
											</div>
